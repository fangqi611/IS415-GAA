...
We will import respopagsex2011to2020.csv file into RStudio and save the file into an R dataframe called popdata.
...
### 2.1.3.1 Data wrangling The following data wrangling and transformation functions will be used:
...
### 2.1.3.2 Joining the attribute data and geospatial data
...
### 2.2.2.2 Drawing a choropleth map using tm_polygons()
...
### 2.3.1.1 Plotting choropleth maps with built-in classification methods
...
### 2.3.1.2 Plotting choropleth map with custome break
...
### 2.2.4.1 Using ColourBrewer palette
...
## 2.2.5 Map Layouts Map

layout refers to the combination of all map elements into a cohensive map. Map elements include among others the objects to be mapped, the title, the scale bar, the compass, margins and aspects ratios. Colour settings and data classification methods covered in the previous section relate to the palette and break-points are used to affect how the map looks.
...
### 2.2.6.1 By assigning multiple values to at least one of the aesthetic arguments
...
### 2.2.6.2 By defining a group-by variable in tm_facets()
...
### 2.2.6.3 By creating multiple stand-alone maps with tmap_arrange()
...
## 2.2.7 Mappping Spatial Object Meeting a Selection Criterion
